...
namespace MgSimpleAnimation2
{
    ...
    class MainMenu
    {
        ...
        /// </summary>
        public enum GameState { mainMenu, enterName, inGame, gameOver }
        ...
        public MainMenu()
        {
            ...
            {   //MainMenu
                ...
                { 
                    ...
                    new GUIElement("001gameOver"), 
                    new GUIElement("001play") 
                }),
                //Enter name menu
                (new List<GUIElement> 
                { 
        ...
        public void LoadContent(ContentManager content, Size windowSize)
        {
            ...
            for (int i = 0; i < menus.Count; i++)
            {
                foreach (GUIElement button in menus[i])
                {
                    ...
                    button.MoveElement(0,j*110-200);
                }
            }
